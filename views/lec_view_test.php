...
<h2 style="text-align:center;"><?php echo $school;?></h2>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <?php echo  '<form action="../controllers/lec_add_question_controller.php?testId='.$testId. '" method="post">';?>
...
<div class="modal fade" id="paper_type" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <?php echo  '<form action="../controllers/lec_paper_type_generator.php?testId='.$testId.'" method="post">';?>
  <div class="form-group">
