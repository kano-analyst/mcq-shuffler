...
<?php echo '<button style="position:center" type="submit"class="btn btn-primary btn-warning"><a  href="../views/lec_view_test.php?testId='.$testId.'"><i class="fa fa-mail-reply-all fa-fw"></i>Back</a></button>'; ?>
...
echo '<div class="page-break">';
  echo '<h2 style="text-align:center;">'.$school.'</h2>';
